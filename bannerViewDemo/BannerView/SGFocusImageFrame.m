...
- (void)setupViews
{
    ...
    for (int i = 0; i < imageItems.count; i++) {
        ...
        //加载图片
        [imageView setImage:[UIImage imageNamed:@"home_banner_default"]];
        //设置banner图片
        [imageView sd_setImageWithURL:[NSURL URLWithString:item.photo] placeholderImage:[UIImage imageNamed:@"home_banner_default"]];
